...
local UIS = game:GetService("UserInputService")-- Made By funceyyy
local WorldToViewportPoint = CurrentCam.WorldToViewportPoint
local mouseLocation = UIS.GetMouseLocation

game:GetService("StarterGui"):SetCore("SendNotification", {Title = "Made By funceyyy", Text = "Enjoy !"})

local DeleteMob ={
	Aimbot= {
		Enabled = false;
		TeamCheck = false;-- Made By funceyyy
		WallCheck = false;
...
local UICorner = Instance.new("UICorner")UICorner.CornerRadius = UDim.new(1, 0) UICorner.Parent = FOVFFrame -- Made By funceyyy
local UIStroke = Instance.new("UIStroke")UIStroke.Color = Color3.fromRGB(100,0,100) UIStroke.Parent = FOVFFrame UIStroke.Thickness = 1 UIStroke.ApplyStrokeMode = "Border" game:GetService("StarterGui"):SetCore("SendNotification", {Title = "https://discord.gg/PQgJrajXV8", Text = "The Discord For More!"})
...
local function AddBox(player)
	...
	local up = left:Clone()-- Made By funceyyy
	up.Parent = outlines
	...
	distancel.BackgroundTransparency = 1-- Made By funceyyy
...
local function AddTracers(Player) -- Tracers Without Lib OMG !!!!, Needs Some Adjustments To The End Pos
	...
	coroutine.resume(co)-- Made By funceyyy
end
...
local Slider3 = Instance.new("Frame")-- Made By funceyyy
...
local TriggerSmoothing = Instance.new("TextButton")-- Made By funceyyy
...
local OTC = Instance.new("TextButton")-- Made By funceyyy
...
local Tracers_B = Instance.new("TextBox")-- Made By funceyyy
...
TextLabel_6.BorderSizePixel = 0-- Made By funceyyy
